...
struct PSBPass : public FunctionPass {
  ...
  bool runOnFunction(Function &F) override {
    ...
    // TAIL DUPLICATION
    printTraces(traces);
    tailDuplication(traces, TraceMap, &F);
...
}; // end of struct OperationStatistics
...
char Correctness::PSBPass::ID = 0;
static RegisterPass<Correctness::PSBPass> X("psbpass", "Profile Super Block Pass");
